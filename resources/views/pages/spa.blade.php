...
<body>
	<div id="app">
		...
		<section class="footer">
			<footer>
				<div class="container">
					<figure class="logo"><img src="{{asset('img/logo2.png')}}" alt=""></figure>
					<nav>
					...
					<p>© {{date('Y')}} - <a class="c-white" href="{{url('/')}}">{{config('app.name')}}</a>. All Rights Reserved. Designed & Developed by <span class="c-white"><a class="c-white" href="https://www.facebook.com/chechepech" target="_blank">Chech&eacute; Pech</a></span></p>
